...
- `raptor trinity --samples-file` now accepts Trinity-style tab-delimited condition/replicate/left/right inputs. The candidate panel gates samples-file workflows across all 6 fixture/insert runs; each reports `sample_count=1` and selected F1 1.0.
