...
- `raptor trinity` now also emits `raptor_components.json`. On the tiny paired-end workflow fixture it reports 1 component containing contigs [0,1] with 492 total bases. This is first Chrysalis-shaped component evidence, not Chrysalis parity: it is shared-sequence clustering of assembled transcripts, not read-backed component graph partitioning.
