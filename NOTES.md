...
- 2026-05-20 `raptor assemble` now accepts `--input2` for paired-end reads. Tiny harness default uses non-overlapping 160 bp inserts and passes truth/oracle min coverage 1.0. Current implementation uses R1 plus reverse-complemented R2 as sequence evidence; it is not yet full Trinity/Butterfly-style paired path support.
