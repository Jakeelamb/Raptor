...
- Raptor `trinity` workflow command, report path, component JSON path/count, component graph JSON path/count, graph node/edge counts, component assigned read/pair counts, and recovery metrics when requested
