...
2. Promote read/k-mer graph construction from a boundary signal and summary into full component de Bruijn graph artifacts, then compare membership/read assignment against Trinity.
