...
2. Replace conservative selected-isoform carry-through with graph/read-pair-supported scoring, then compare component membership/read assignment against Trinity.
