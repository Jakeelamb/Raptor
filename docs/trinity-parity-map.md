...
- candidate panel gate: `python3 bench/trinity_parity/run_panel.py` runs 6 fixture/insert combinations and writes `target/trinity_parity/candidate_panel/panel_report.json`. Current result passes all cases: tiny insert sweep selected lengths [252,240] with precision/recall/F1 1.0 for inserts 110,140,160,180; ambiguous paralog selected lengths [240,234,240] with precision/recall/F1 1.0; compact fusion selected lengths [216,216] with precision/recall/F1 1.0.
