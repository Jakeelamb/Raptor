use crate::io::fastq::{
    open_fastq, stream_fastq_records, stream_paired_fastq_records, FastqWriter,
};
...
pub fn normalize_single(input_path: &str, output_prefix: &str, _use_gpu: bool, streaming: bool) {
    ...
    info!(
        ...
        kept_count,
        total_records,
        (kept_count as f64 / total_records as f64) * 100.0,
...
pub fn normalize_paired(
    ...
    info!(
        ...
        kept_count,
        total_pairs,
        (kept_count as f64 / total_pairs as f64) * 100.0,
        second_pass_start.elapsed()
    );
}
