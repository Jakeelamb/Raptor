    ...
    match cli.command {
        ...
        Commands::Stats {
            ...
            match format.as_str() {
                ...
                "tsv" => {
                    println!(
                        "contigs\ttotal_len\tavg_len\tmedian_len\tgc_bases\tacgt_bases\tn_bases\tambiguous_bases\tmean_rle_ratio\tlength_weighted_rle_ratio\ttotal_rle_runs\tgc_content\tn_content\tambiguous_content\tn10\tn25\tn50\tn75\tn90\tn95\tn99\tl10\tl25\tl50\tl75\tl90\tl95\tl99\taun\tlongest\tcontigs_ge_1kb\tcontigs_ge_10kb\tcontigs_ge_50kb\tcontigs_ge_100kb\tbases_ge_1kb\tbases_ge_10kb\tbases_ge_50kb\tbases_ge_100kb\tcontigs_ge_1kb_frac\tcontigs_ge_10kb_frac\tcontigs_ge_50kb_frac\tcontigs_ge_100kb_frac\tbases_ge_1kb_frac\tbases_ge_10kb_frac\tbases_ge_50kb_frac\tbases_ge_100kb_frac\tn_run_count\tmax_n_run\tcontigs_with_n\tcontigs_with_ambiguous\tcontigs_all_acgt\tcontigs_with_n_frac\tcontigs_with_ambiguous_frac\tcontigs_all_acgt_frac"
                    );
                    println!(
                        "{}\t{}\t{:.2}\t{:.2}\t{}\t{}\t{}\t{}\t{:.6}\t{:.6}\t{}\t{:.6}\t{:.6}\t{:.6}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{:.2}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{:.6}\t{:.6}\t{:.6}\t{:.6}\t{:.6}\t{:.6}\t{:.6}\t{:.6}\t{}\t{}\t{}\t{}\t{}\t{:.6}\t{:.6}\t{:.6}",
                        stats.total_contigs,
                        stats.total_length,
                        ...
                        stats.mean_rle_ratio,
                        stats.length_weighted_rle_ratio,
                        stats.total_rle_runs,
                        stats.gc_content,
                        stats.n_content,
                        ...
                        stats.contigs_ge_1kb,
                        stats.contigs_ge_10kb,
                        stats.contigs_ge_50kb,
                        stats.contigs_ge_100kb,
                        stats.bases_ge_1kb,
                        stats.bases_ge_10kb,
                        stats.bases_ge_50kb,
                        stats.bases_ge_100kb,
                        stats.contigs_ge_1kb_frac,
                        stats.contigs_ge_10kb_frac,
                        stats.contigs_ge_50kb_frac,
                        stats.contigs_ge_100kb_frac,
